...
if(isset($_GET['article']) && isset($_GET['article']) && isset($_GET['article'])){
...
// En réalité nous passons l'identifiant du produit dans l'URL afin d'en séléctionner les informations dans la BDD